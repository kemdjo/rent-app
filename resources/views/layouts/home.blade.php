        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="https://codecanyon.net/item/rentzone-laravel-rental-management-system/22598152"></i>Purchase</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<footer id="footer-main">
    <div class="container">
        <div class="col-md-3">
            <h6>{!! trans('home.ABOUT') !!} <span>RentZone</span></h6>
            <div class="text">
        ...
        <div class="col-md-3">
            ...
            <div class="text">
                <p><span>Rentzone {!! trans('home.office') !!} 1:</span> (323) 938-5798</p>
                <p><span>Rentzone {!! trans('home.office') !!} 2:</span> (888) 637-7262</p>
                <p><span>Email:</span> <a href="mailto:rent@zone.com">rent@zone.com</a></p>
            </div>
        </div>
        <div class="col-md-3">
